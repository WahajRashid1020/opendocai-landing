          ...
          <div className="container px-4 mx-auto">
            <div className="flex flex-wrap">
              <div className="w-full lg:w-1/2 lg:p-8 flex flex-col justify-center">
                ...
                <RevealWrapper>
                  <p className="w-full dark:text-gray-300  text-gray-900 font-medium md:max-w-md md:text-lg">
                    Get the best-in-class group mentoring plans and professional
                    benefits for your team
                  </p>
                </RevealWrapper>

                <div className="w-full mt-8 flex md:flex-row lg:flex-wrap flex-col -m-2.5">
                  <div className="md:w-auto p-2.5 w-full">
                    <div className="block">
                      <button
                  ...
                  <div className="w-full md:w-auto p-2.5">
                    <div className="block">
                      <button
                        className="py-4 px-9 w-full font-semibold border dark:hover:text-black  border-gray-300 hover:border-gray-400 rounded-xl focus:ring focus:ring-gray-50 bg-transparent hover:bg-gray-100 transition ease-in-out duration-200"
                        type="button"
                      >
              ...
              <div className="w-full lg:w-1/2 p-8 flex ">
                <iframe
                  width={600}
                  className="aspect-video h-auto rounded-2xl"
                  src="https://www.youtube.com/embed/5eTDwzgYe78?si=Fwq_Mn0-ZOUsgoP9"
